...
enum ReadingSourceCatalog {
    static let curatedSources: [ReadingSource] = [
        ...
        ReadingSource(
            ...
            licenseKind: .thirdPartyTerms,
            licenseNote: "User-initiated import only. Stories are individually authored; review site terms before any reuse.",
        ...
        ReadingSource(
            ...
            licenseKind: .thirdPartyTerms,
            licenseNote: "User-initiated import only. Community-posted material; review site terms before reuse.",
        ...
        ReadingSource(
            ...
            licenseKind: .thirdPartyTerms,
            licenseNote: "User-initiated import only. Stories are user-submitted; review site terms before reuse.",
        ...
        ReadingSource(
            ...
            licenseKind: .thirdPartyTerms,
            licenseNote: "User-initiated import only. Review site terms before reuse.",
            contentNote: "Adult (18+) erotic hypnosis content.",
            importPolicy: .userInitiatedImport,
            contentRating: .adultOnly,
            isCurated: true,
        ...
        ReadingSource(
            ...
            licenseKind: .thirdPartyTerms,
            licenseNote: "User-initiated import only. User-submitted material; review site terms before reuse.",
            contentNote: "Adult (18+) erotic hypnosis content.",
            importPolicy: .userInitiatedImport,
            contentRating: .adultOnly,
            isCurated: true,
